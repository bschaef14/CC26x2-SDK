...
class ITMTimestampFrame(ITMFrame):
    ...
    def parse(self, buf):
        ...
        try:
            ...
            logger.info("Reserved code (0x%x) used for timestamp", self.header >> 4)
                ...
                # Source packets have non-zero least significant bits
                    ...
                    # 3rd bit == 1 --> Hardware Source
                        ...
                        # This is a hardware trace packet
                            ...
                            frame = ITMSourceHwTraceFrame(header, hw_packet_type=hw_packet_type,
