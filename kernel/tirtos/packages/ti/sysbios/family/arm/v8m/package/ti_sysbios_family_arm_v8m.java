...
public class ti_sysbios_family_arm_v8m
{
    ...
    void Hwi$$OBJECTS()
    {
        ...
        spo = (Proto.Obj)om.bind("ti.sysbios.family.arm.v8m.Hwi$$IsrCallStackFrame", new Proto.Obj());
        om.bind("ti.sysbios.family.arm.v8m.Hwi.IsrCallStackFrame", new Proto.Str(spo, false));
    ...
    void Hwi$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.v8m.Hwi.ramVectors", new Extern("ti_sysbios_family_arm_v8m_Hwi_ramVectors", "xdc_UInt32[]*", false, false));
        ...
        om.bind("ti.sysbios.family.arm.v8m.Hwi.svcHandlerAsm", new Extern("ti_sysbios_family_arm_v8m_Hwi_svcHandlerAsm__I", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.v8m.Hwi.svcHandler", new Extern("ti_sysbios_family_arm_v8m_Hwi_svcHandler__I", "xdc_UInt32(*)(xdc_UInt32*,xdc_UInt)", true, false));
    ...
    void TaskSupport$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.v8m.TaskSupport.getCheckValueAddr", new Extern("ti_sysbios_family_arm_v8m_TaskSupport_getCheckValueAddr__E", "xdc_Ptr(*)(xdc_Ptr)", true, false));
    }
    ...
    void Hwi$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("E_badIntNum", (Proto)om.findStrict("xdc.runtime.Error$$Id", "ti.sysbios.family.arm.v8m"), Global.newObject("msg", "E_badIntNum, intnum: %d is out of range"), "w");
        ...
        // struct Hwi.IsrCallStackFrame
        po = (Proto.Obj)om.findStrict("ti.sysbios.family.arm.v8m.Hwi$$IsrCallStackFrame", "ti.sysbios.family.arm.v8m");
        po.init("ti.sysbios.family.arm.v8m.Hwi.IsrCallStackFrame", null);
                po.addFld("$hostonly", $$T_Num, 1, "r");
                po.addFld("frame", $$T_Str, $$UNDEF, "w");
    ...
    void Hwi$$SINGLETONS()
    {
        ...
        vo.bind("IsrCallStackFrame", om.findStrict("ti.sysbios.family.arm.v8m.Hwi.IsrCallStackFrame", "ti.sysbios.family.arm.v8m"));
        tdefs.add(om.findStrict("ti.sysbios.family.arm.v8m.Hwi.IsrCallStackFrame", "ti.sysbios.family.arm.v8m"));
        ...
        vo.bind("ramVectors", om.findStrict("ti.sysbios.family.arm.v8m.Hwi.ramVectors", "ti.sysbios.family.arm.v8m"));
        ...
        vo.bind("svcHandlerAsm", om.findStrict("ti.sysbios.family.arm.v8m.Hwi.svcHandlerAsm", "ti.sysbios.family.arm.v8m"));
        vo.bind("svcHandler", om.findStrict("ti.sysbios.family.arm.v8m.Hwi.svcHandler", "ti.sysbios.family.arm.v8m"));
